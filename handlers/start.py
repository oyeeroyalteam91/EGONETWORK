...
def panel_keyboard(page: int = 1) -> InlineKeyboardMarkup:
    if page == 1:
        rows = [
            [InlineKeyboardButton(s("Access Setup"), callback_data="azai_setup"), InlineKeyboardButton(s("Command Hall"), callback_data="azai_help")],
            [InlineKeyboardButton(s("Royal Shop"), callback_data="azai_shop"), InlineKeyboardButton(s("Quiz Arena"), callback_data="azai_quiz")],
            [InlineKeyboardButton(s("Event Core"), callback_data="azai_events"), InlineKeyboardButton(s("User Vault"), callback_data="azai_profile")],
        ...
        rows = [
            [InlineKeyboardButton(s("Owner Panel"), callback_data="azai_owner"), InlineKeyboardButton(s("Group Panel"), callback_data="azai_group")],
            [InlineKeyboardButton(s("Verify Core"), callback_data="azai_verify"), InlineKeyboardButton(s("Game Zone"), callback_data="azai_games")],
            [InlineKeyboardButton(s("Sticker Core"), callback_data="azai_stickers"), InlineKeyboardButton(s("AI Chat"), callback_data="azai_ai")],
...
async def azai_panel(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    replies = {
        "azai_setup": f"{s('Setup Panel')}\n/setup",
        "azai_help": f"{s('Command Hall')}\n/help\n/commands",
        "azai_shop": f"{s('Royal Shop')}\n/shop\n/additem key price name\n/setshopmedia key",
        "azai_quiz": f"{s('Quiz Arena')}\n/animequiz\n/gkquiz\n/animepickeys\n/setanimepic key\n/autoquiz",
        "azai_events": f"{s('Event Core')}\n/events\n/eventstatus\n/addevent key DD-MM coins name",
        "azai_profile": f"{s('User Vault')}\n/profile\n/setup\n/inventory",
        "azai_donate": s("Donate panel is not connected yet. Owner can add donation link later."),
        "azai_owner": f"{s('Owner Panel')}\n/owner",
        "azai_group": f"{s('Group Panel')}\n/group",
        "azai_verify": f"{s('Verify Core')}\n/verify\n/verifyon\n/verifyoff",
        "azai_games": f"{s('Game Zone')}\n/dice\n/dart\n/basketball\n/football\n/bowling\n/slot",
        "azai_stickers": f"{s('Sticker Core')}\n/addsticker keyword\n/removesticker keyword\n/stickers",
        "azai_ai": s("AI Chat: mention AZAI or say hi, help, shop, quiz, problem."),
    }
