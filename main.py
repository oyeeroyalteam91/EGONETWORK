...
USER_COMMANDS = {
    ...
    "top": leaderboard,
    "setleaderpic": set_leader_pic,
    "setpic": set_custom_pic,
    "getpic": get_custom_pic,
    "pics": list_custom_pics,
    "animequiz": anime_quiz,
    "gkquiz": gk_quiz,
    "animepickeys": anime_pic_keys,
    "dice": dice,
    "dart": dart,
...
OWNER_COMMANDS = {
    ...
    "unmute": soft_unmute,
    "warns": show_warnings,
    "clearwarns": clear_warnings,
    "broadcast": broadcast,
    "group": group_panel,
    "verifyon": verify_on,
    "verifyoff": verify_off,
    "setwelcome": set_welcome_pic,
    "setstartpic": set_start_pic,
    "setstartmedia": set_start_media,
    "startmedia": show_start_media,
    "setpanelphoto": set_panel_photo,
    "setshopmedia": set_shop_media,
    "additem": add_shop_item,
    "addpoints": add_manual_points,
    "setanimepic": set_anime_quiz_pic,
    "autoquiz": autoquiz_toggle,
    "autoquizon": enable_auto_quiz,
    "autoquizoff": disable_auto_quiz,
    "addevent": add_event,
    "addsticker": add_sticker_reply,
    "removesticker": remove_sticker_reply,
}
...
def build_app() -> Application:
    ...
    app.add_handler(CallbackQueryHandler(profile_option_callback, pattern="^profile_option:"))
    ...
    if app.job_queue:
        ...
        app.job_queue.run_daily(
            daily_event_job,
            time=time(hour=0, minute=5, tzinfo=INDIA_TZ),
            name="india_daily_events",
        )
